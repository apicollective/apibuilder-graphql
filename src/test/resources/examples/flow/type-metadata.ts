...
export const models = new Models([
  new EnumData("OrganizationStatus", [
    new EnumValue("ACTIVE", "active"),
    new EnumValue("INACTIVE", "inactive"),
    new EnumValue("DEACTIVATED", "deactivated")
  ]),
  new EnumData("Environment", [
    new EnumValue("SANDBOX", "sandbox"),
    new EnumValue("PRODUCTION", "production")
  ]),
  new EnumData("B2bInvoiceType", [
    new EnumValue("SELF_BILL_INVOICE", "self_bill_invoice"),
    new EnumValue("INVOICE", "invoice")
  ]),
  ...
  new ModelData("Organization", [
    ...
    field("status", "status", "OrganizationStatus", "enum")
  ]),
  ...
  new ModelData("B2bInvoice", [
    ...
    field("attributes", "attributes", "Object", "scalar"),
    field("estimatedDeliveryDate", "estimated_delivery_date", "DateTimeIso8601", "scalar"),
    field("b2bInvoiceType", "b2b_invoice_type", "B2bInvoiceType", "enum")
  ]),
  ...
  new ModelData("Checkout", [
    field("id", "id", "String", "scalar"),
    field("organization", "organization", "CheckoutOrganizationSummary", "type"),
    field("geo", "geo", "CheckoutGeoParameters", "type"),
    field("orderNumber", "order_number", "String", "scalar"),
    field("startingSequenceNumber", "starting_sequence_number", "Long", "scalar")
  ]),
  new ModelData("CheckoutOrganizationSummary", [
    field("id", "id", "String", "scalar"),
    field("environment", "environment", "Environment", "enum")
  ]),
  new ModelData("CheckoutGeoParameters", [
    field("experienceKey", "experience_key", "String", "scalar"),
    field("country", "country", "String", "scalar"),
    field("ip", "ip", "String", "scalar"),
    field("currency", "currency", "String", "scalar"),
    field("language", "language", "String", "scalar"),
    field("locale", "locale", "String", "scalar")
  ]),
  ...
  new ModelData("CheckoutInput", [
    field("id", "id", "String", "scalar"),
    field("organization", "organization", "CheckoutOrganizationSummaryInput", "input"),
    field("geo", "geo", "CheckoutGeoParametersInput", "input"),
    field("orderNumber", "order_number", "String", "scalar"),
    field("startingSequenceNumber", "starting_sequence_number", "Long", "scalar")
  ]),
  new ModelData("CheckoutOrganizationSummaryInput", [
    field("id", "id", "String", "scalar"),
    field("environment", "environment", "Environment", "enum")
  ]),
  new ModelData("CheckoutGeoParametersInput", [
    field("experienceKey", "experience_key", "String", "scalar"),
    field("country", "country", "String", "scalar"),
    field("ip", "ip", "String", "scalar"),
    field("currency", "currency", "String", "scalar"),
