...
export const models = new Models([
  new EnumData("OrganizationType", [
    new EnumValue("STANDALONE", "standalone"),
    new EnumValue("CHANNEL", "channel")
  ]),
  new EnumData("EntityIdentifierType", [
    new EnumValue("IOSS", "ioss"),
    new EnumValue("VOEC", "voec"),
    new EnumValue("ZAZ", "zaz")
  ]),
  new EnumData("OrganizationStatus", [
    ...
    new EnumValue("PROVISIONED", "provisioned")
  ]),
  ...
  new ModelData("MerchantOfRecordEntity", [
    ...
    field("identifiers", "identifiers", "EntityIdentifier", "array"),
  ...
  new ModelData("Organization", [
    ...
    field("type", "type", "OrganizationType", "enum")
  ]),
  new ModelData("EntityIdentifier", [
    field("name", "name", "EntityIdentifierType", "enum"),
    field("number", "number", "String", "scalar"),
    field("issuingCountry", "issuing_country", "String", "scalar")
  ]),
  ...
  new ModelData("MerchantOfRecordEntityInput", [
    ...
    field("identifiers", "identifiers", "EntityIdentifierInput", "array"),
    field("streets", "streets", "String", "array"),
    field("city", "city", "String", "scalar"),
    field("province", "province", "String", "scalar"),
    field("postal", "postal", "String", "scalar"),
  ...
  new ModelData("EntityIdentifierInput", [
    field("name", "name", "EntityIdentifierType", "enum"),
    field("number", "number", "String", "scalar"),
    field("issuingCountry", "issuing_country", "String", "scalar")
  ]),
